...
Route::middleware('auth')->group(function () {
    ...
    Route::delete('roles/{user}/delete', [\App\Http\Controllers\rolesController::class, 'destroy'])->name('roles.destroy');
    ...
    Route::get('permissions/{user}/show', [\App\Http\Controllers\PermissionsController::class, 'show'])->name('permissions.show');
    Route::get('permissions/{user}/edit', [\App\Http\Controllers\PermissionsController::class, 'edit'])->name('permissions.edit');
    Route::patch('permissions/{user}/update', [\App\Http\Controllers\PermissionsController::class, 'update'])->name('permissions.update');
    Route::delete('permissions/{user}/delete', [\App\Http\Controllers\PermissionsController::class, 'destroy'])->name('permissions.destroy');
